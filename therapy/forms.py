...
class TherapyPatientEditForm(forms.ModelForm):
    ...
    hospital = forms.ModelChoiceField(queryset=Hospital.objects.all(),
                                      required=True,
                                      initial=None,
                                      label=_('Обращение в больницу'),
                                      widget=Select2(select2attrs={'width': '100%'}),
                                      )
    hospital_therapy = forms.ModelChoiceField(queryset=Hospital.objects.all(),
                                              required=True,
                                              initial=None,
                                              label=_('Больница, где проходило лечение'),
                                              widget=Select2(select2attrs={'width': '100%'}),
                                              )
    department_therapy_0 = forms.CharField(required=False,
                                            label=_('Отделение'),
                                            widget=forms.Textarea(attrs={'rows':3, }))
    department_therapy_1 = forms.CharField(required=False,
                                            label=_('Отделение'),
                                            widget=forms.Textarea(attrs={'rows':3, }))
    department_therapy_2 = forms.CharField(required=False,
                                            label=_('Отделение'),
                                            widget=forms.Textarea(attrs={'rows':3, }))
    ...
    therapy_description_0 = forms.CharField(required=False,
                                            label=_('Предоставленное лечение'),
                                            widget=forms.Textarea(attrs={'rows':3, }))
    therapy_description_1 = forms.CharField(required=False,
                                            label=_('Предоставленное лечение'),
                                            widget=forms.Textarea(attrs={'rows':3, }))
    therapy_description_2 = forms.CharField(required=False,
                                            label=_('Предоставленное лечение'),
                                            widget=forms.Textarea(attrs={'rows':3, }))

    doctor_0 = forms.CharField(required=False,
                                            label=_('Лечащий врач'),
                                            widget=forms.TextInput())
    doctor_1 = forms.CharField(required=False,
                                            label=_('Лечащий врач'),
                                            widget=forms.TextInput())
    doctor_2 = forms.CharField(required=False,
                                            label=_('Лечащий врач'),
                                            widget=forms.TextInput())
    ...
    class Meta:
        ...
        fields = [
            ...
            'hospital', 'hospital_therapy', 'income_date', 'exit_date',
            'department_therapy_0', 'department_therapy_1', 'department_therapy_2',
            'therapy_description_0', 'therapy_description_1', 'therapy_description_2',
            'doctor_0', 'doctor_1', 'doctor_2',
            'price_man',
        ]
            ...
            Div(
                TabHolder(
                    Tab(_('Туркменский'),
                        ...
                        Div(
                            Div('hospital_therapy', css_class='col-6', ),
                            Div('department_therapy_2', css_class='col-6', ),
                            css_class='row',
                        ),
                        Div(
                            Div('doctor_2', css_class='col-6', ),
                            Div('income_date', css_class='col-3', ),
                            Div('exit_date', css_class='col-3', ),
                            css_class='row'
                        ),
                        'therapy_description_2',
                        Div('price_man', css_class='col-4', ),
                    ),
                    Tab(_('Русский'),
                        Div('diagnosis_1', css_class='col-12',),
                        Div('department_therapy_1', css_class='col-12',),
                        Div('doctor_1', css_class='col-6', ),
                        'therapy_description_1',
                    ),
                    # Tab(_('Английский'),
                    #     Div('diagnosis_0', css_class='col-12',),
                    # Div('department_therapy_0', css_class='col-12', ),
                    #     Div('doctor_0', css_class='col-6', ),
                    #     'therapy_description_0',
                    # ),
                ),
...
class TherapyCreateStepTwoForm(TherapyPatientEditForm):
...
class TherapyCreateStepTwoForm_orig(forms.ModelForm):
    new_patient_id = forms.IntegerField(required=False)
    ...
    class Meta:
        ...
        fields = [
            'id', 'patient',
            'diagnosis_0', 'diagnosis_1', 'diagnosis_2',
            'hospital', 'income_date', 'exit_date',
            'doctor_0', 'doctor_1', 'doctor_2',
            'therapy_description_0', 'therapy_description_1', 'therapy_description_2',
            'price_man',
        ]
...
class TherapyPatientSearchForm(forms.Form):
            ...
            Div(
                ...
                Div(
                    ...
                    Div(
                        ...
                        css_class='col-4 align-self-end',
                    ),
                    css_class='row'
                ),
